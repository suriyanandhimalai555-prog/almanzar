        ...
        <div className="min-h-screen bg-[#F4F8FF] text-gray-900 font-sans flex flex-col relative overflow-hidden selection:bg-[#2B6CF0] selection:text-white">
            ...
            <div className="flex-1 flex flex-col lg:flex-row items-center justify-center max-w-[1200px] mx-auto w-full px-6 gap-10 lg:gap-16 relative z-10 pb-10 pt-2">
                ...
                <div className="w-full max-w-[460px] flex flex-col items-center">
                    <div className="w-full bg-white border border-gray-200 rounded-[1.5rem] px-8 py-6 lg:px-10 lg:py-7 shadow-[0_10px_60px_rgba(43,108,240,0.08)] relative overflow-hidden">
                        ...
                        <div className="flex flex-col items-center mb-5">
                            <div className="bg-gradient-to-br from-[#2B6CF0] to-[#1E40AF] text-white p-3 rounded-[1rem] mb-3 shadow-[0_4px_20px_rgba(43,108,240,0.3)]">
                                <BsBoxSeam className="text-xl stroke-[0.5]" />
                            </div>
                            <h2 className="text-xl lg:text-2xl font-bold text-gray-900 mb-1">Create Account</h2>
                            <p className="text-gray-500 text-[11px] lg:text-xs">Sign up to manage API keys & cards</p>
                        </div>
                        ...
                        <form className="space-y-3" onSubmit={handleRegister}>
                            <div>
                                <label className="block text-[#1E40AF] text-[9px] font-bold tracking-widest uppercase mb-1 ml-1">
                                    Company / Full Name
                                </label>
                                <div className="flex items-center bg-[#F4F8FF] border border-gray-200 rounded-xl px-4 py-2.5 focus-within:border-[#2B6CF0] focus-within:ring-1 focus-within:ring-[#2B6CF0] transition-all group">
                                    <BiUser className="text-gray-400 group-focus-within:text-[#2B6CF0] mr-3 text-base transition-colors" />
                                    <input
                                        type="text"
                                        name="companyName"
                            ...
                            <div>
                                ...
                                <div className="flex items-center bg-[#F4F8FF] border border-gray-200 rounded-xl px-4 py-2.5 focus-within:border-[#2B6CF0] focus-within:ring-1 focus-within:ring-[#2B6CF0] transition-all group">
                                    <BiEnvelope className="text-gray-400 group-focus-within:text-[#2B6CF0] mr-3 text-base transition-colors" />
                                    <input
                                        type="email"
                                        name="email"
                            ...
                            <div>
                                ...
                                <div className="flex items-center bg-[#F4F8FF] border border-gray-200 rounded-xl px-4 py-2.5 focus-within:border-[#2B6CF0] focus-within:ring-1 focus-within:ring-[#2B6CF0] transition-all group">
                                    <FiLock className="text-gray-400 group-focus-within:text-[#2B6CF0] mr-3 text-base transition-colors" />
                                    <input
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-gradient-to-r from-[#2B6CF0] to-[#1E40AF] hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-xs lg:text-sm py-3 rounded-xl mt-2 transition-all duration-200 shadow-[0_5px_20px_rgba(43,108,240,0.25)] hover:shadow-[0_5px_25px_rgba(43,108,240,0.35)] hover:-translate-y-0.5"
                            >
                        ...
                        <div className="mt-4 text-center">
                            <p className="text-gray-500 text-[11px] lg:text-xs">
                                Already have an account? <a href="/distributor/login" className="text-[#2B6CF0] hover:text-[#1E40AF] transition-colors hover:underline font-semibold ml-1">Sign In</a>
                            </p>
                        </div>
                    </div>
